...
namespace sale_stations.PL
{
    ...
    {
        SqlConnection conn = new SqlConnection(@"server=.\SQLEXPRESS;database=sales_db;integrated security=true");
        SqlCommand cmd;
        public createBackup()
        {
            InitializeComponent();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string query = "Backup Database sales_db to Disk='" + filename + ".bak'";
